...
export const Wheels: React.FC<WheelsProps> = ({ 
  ...
  useEffect(() => {
    ...
    const handleMouseUp = () => {
      ...
      // Removed snap-back logic to keep pitch fixed
    };
  ...
  return (
    <div className="flex gap-6 h-48 select-none bg-gray-900 p-4 rounded-xl shadow-2xl border border-gray-800">
      {/* PITCH BEND */}
      <div className="flex flex-col items-center gap-2">
        <div 
          ref={pitchRef}
          onMouseDown={() => isDraggingPitch.current = true}
          className="relative w-12 h-full bg-gray-800 rounded-lg cursor-ns-resize overflow-hidden border border-gray-700 shadow-inner group"
        >
          {/* Center Line */}
